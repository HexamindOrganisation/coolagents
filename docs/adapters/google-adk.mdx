...
<Info>
**Compatible versions:** `google-adk` **1.14.0 – 2.5.0** (verified by hexgate's
framework-version matrix, spanning the 1.x → 2.x line). See the [full compatibility
table](/adapters/openai#compatible-framework-versions).
</Info>
